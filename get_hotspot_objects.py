...
def main():
    ...
    for each_hotspot in list_of_hotspots:
        hotspot_id = each_hotspot
        ...
        df_species, complete_dataframe_sorted, dataframe_with_complete_checklists = each_hotspot(hotspot_path,
                                                                                                 hotspot_id, 
                                                                                                 all_species_list, 
                                                                                                 category)
